...
public class Game {
	 ...
	 * 
	 * DESCRIPTION: sets the game to two player mode
	 * 
	 * 
	...
	/***************************************************************************************
	 * FUNCTION: getTwoPlayerMode
	 * 
	 * DESCRIPTION: checks to see if we're in two player mode
	 * 
	 * 
	 * METHOD: getTwoPlayerMode()
	 * 
	 * RETURNS: boolean
	 *
